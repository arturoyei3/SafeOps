...
namespace Inspinia_MVC5
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // CSS Landing Refresh styles
            bundles.Add(new StyleBundle("~/landing/refresh/css").Include("~/Content/landing/refresh/assets/vendor/bootstrap/css/bootstrap.css",
                      "~/Content/landing/refresh/assets/vendor/font-awesome/css/all.min.css",
                      "~/Content/landing/refresh/assets/vendor/font-awesome/css/fontawesome.min.css",
                      "~/Content/landing/refresh/assets/vendor/cubeportfolio/css/cubeportfolio.min.css",
                      "~/Content/landing/refresh/assets/css/header-new.css",
                      "~/Content/landing/refresh/assets/css/style.css",
                      "~/Content/landing/refresh/assets/css/shortcodes.css",
                      "~/Content/landing/refresh/assets/css/utilities.css",
                      "~/Content/landing/refresh/assets/css/skin/default.css",
                      "~/Content/landing/refresh/assets/css/custom.css"));


            // CSS Landing Refresh styles
            bundles.Add(new StyleBundle("~/landing/refresh/js").Include("~/Content/landing/refresh/assets/vendor/jquery/jquery.min.js",
                      "~/Content/landing/refresh/assets/vendor/jquery/jquery-migrate.min.js",
                      "~/Content/landing/refresh/assets/vendor/jquery/jquery.visible.min.js",
                      "~/Content/landing/refresh/assets/vendor/bootstrap/js/popper.js",
                      "~/Content/landing/refresh/assets/vendor/bootstrap/js/bootstrap.min.js",
                      "~/Content/landing/refresh/assets/vendor/cubeportfolio/js/jquery.cubeportfolio.min.js",
                      "~/Content/landing/refresh/assets/vendor/sweetalert/sweetalert.min.js",
                      "~/Content/landing/refresh/assets/js/cubeportfolio.init.js",
                      "~/Content/landing/refresh/assets/vendor/slick-slider/slick.js",
                      "~/Content/landing/refresh/assets/vendor/svg-injector/svg-injector.min.js",
                      "~/Content/landing/refresh/assets/js/page.js",
                      "~/Content/landing/refresh/assets/js/other.js",
                      "~/Content/landing/refresh/assets/js/script.js",
                      "~/Content/landing/refresh/assets/js/custom.js"));
